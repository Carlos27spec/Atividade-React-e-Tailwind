...
export const produtosCategoria1 = [
  {
    nome: "Tenis Nike Air Max",
    descricao: "Tenis bonito e confortável, ótimo para aquele role.",
    img: "./src/assets/tenis/tenis-nike-1.jpg",
  },
  {
    nome: "Tenis Nike Revolution 5",
    descricao: "Tenis leve e confortável para corrida.",
    img: "./src/assets/tenis/tenis-nike-2.jpg",
  },
  {
    nome: "Tenis Mizuno Wave Rider",
    descricao: "Tenis bonito e confortável, ótimo para aquele role.",
    img: "./src/assets/tenis/tenis-mizuno-1.jpg",
  },
  {
    nome: "Tenis Mizuno Wave Prophecy",
    descricao: "Tenis leve e confortável para corrida.",
    img: "./src/assets/tenis/tenis-mizuno-2.jpg",
  },
  {
    nome: "Tenis All Star Converse",
    descricao: "Tenis bonito e confortável, ótimo para aquele role.",
    img: "./src/assets/tenis/tenis-allstar-1.jpg",
  },
  {
    nome: "Tenis All Star Converse Chuck Taylor",
    descricao: "Tenis leve e confortável para corrida.",
    img: "./src/assets/tenis/tenis-allstar-2.jpg",
  },
  {
    nome: "Tenis Adidas Ultraboost",
    descricao: "Tenis bonito e confortável, ótimo para aquele role.",
    img: "./src/assets/tenis/tenis-adidas-1.jpg",
  },
  {
    nome: "Tenis Adidas Superstar",
    descricao: "Tenis leve e confortável para corrida.",
    img: "./src/assets/tenis/tenis-adidas-2.jpg",
  },
];
